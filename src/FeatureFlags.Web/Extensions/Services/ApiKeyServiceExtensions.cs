...
public static class ApiKeyServiceExtensions {
    ...
    /// </summary>
    /// <param name="query">The source sequence of <see cref="ApiKey"/> objects to project.</param>
    /// <returns>An <see cref="IQueryable{ApiKeyModel}"/> sequence where each element is a projection of the corresponding
    /// element in the source sequence.</returns>
